...
#ifndef RADIUINO4APP_H
#define RADIUINO4APP_H 1
...
extern packet g_pkt;               /* Pacote */
extern byte my_addr;               /* Endereço */
extern byte power;                 /* Potência */
extern byte channel;               /* Canal */
extern byte freq_offset;           /* Offset de frequencia */
extern int serial_baudrate;        /* Serial baudrate */
extern int set_radio;			   /* Variavel para ajustar o tipo de rádio*/
extern byte serialData[65];
